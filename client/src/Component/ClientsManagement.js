                ...
                {addClients?.map((item, index) => {
                  return (
                    <tr className="tr_C" key={item._id}>
                      ...
                      <td className="td_S p-1">{item.clientsName}</td>
                      <td className="td_S p-1">{item.ClientBusinessName}</td>
                      <td className="td_S p-1">{item.ClientsContactNumber1}</td>
          ...
          <div className="row containerPadding m-auto">
            ...
            <div className="containerPadding mt-3 card">
              <div className="row ">
                <img
                  variant="top"
                  src={`http://localhost:8000/ClientImage/${clientID?.ClientImage}`}
                  alt=""
                  style={{
                    width: "150px",
                    height: "150px",
