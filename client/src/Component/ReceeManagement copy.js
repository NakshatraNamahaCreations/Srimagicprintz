    ...
    if (importXLSheet.length > 0) {
      ...
      try {
        const res = await axios.post(
          "https://admin.srimagicprintz.com/api/recce/recce/addreccesviaexcelesheet",
          importXLSheet
        );
        if (res.status === 200) {
      ...
      if (
        ...
        try {
          const response = await axios.post(
            `https://admin.srimagicprintz.com/api/recce/recce/getcompletedid/${recceData._id}`
          );
          ...
          <>
            <div className="row ">
              <div className="col-md-8">
                <div className="row">
                  <Button className="col-md-2 m-1" href="/Recceapi">
                    Add Recce
                  </Button>
            ...
            <div className="row m-auto">
              ...
              >
                ...
                <div className="row m-auto">
                  <p style={{ color: "black" }}>
                    Total Completed <span style={{ color: "green" }}> 54</span>
                  </p>
                </div>
              </Card>
              <Card
              ...
              >
                ...
                <div className="row m-auto">
                  <p style={{ color: "black" }}>
                    Total Pending <span style={{ color: "red" }}> 54</span>
                  </p>
                </div>
              </Card>
              <Card
              ...
              >
                ...
                <div className={`row m-auto ${"active"}`}>
                  <p style={{ color: "black" }}>
                    Total Processing{" "}
                    <span style={{ color: "orange" }}> 54</span>
                  </p>
                </div>
              </Card>
              <Card
              ...
              >
                ...
                <div className="row m-auto">
                  <p style={{ color: "black" }}>
                    Total Canceled <span style={{ color: "red" }}> 54</span>
                  </p>
                </div>
              </Card>
            </div>
